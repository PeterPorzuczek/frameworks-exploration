...
*/
import chromeFavicon from '../../assets/images/favicon.ico';
import appleFavicon from '../../assets/images/favicon.ico';
import msFavicon from '../../assets/images/favicon.ico';
...
const metaAssets = () => {
  return [
    ...
    { name: 'description', content: 'React App example' },
